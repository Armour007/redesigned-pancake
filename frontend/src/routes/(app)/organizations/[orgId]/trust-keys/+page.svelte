<script lang="ts">
  ...
  type TrustKey = { id: string; kid: string; alg: string; active: boolean; created_at: string; deactivate_after?: string };
  ...
  async function createKey() {
    const orgId = $page.params.orgId;
    const body = JSON.stringify({ kid: newKid || undefined, active: false });
