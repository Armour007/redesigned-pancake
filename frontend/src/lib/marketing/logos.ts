// Tip: Swap logo files in `static/logos/` and update alt text to the exact brand name.
...
export const logos: Logo[] = [
  ...
  { src: '/logos/logo4.svg', alt: 'Umbrella Corporation logo' },
  { src: '/logos/logo5.svg', alt: 'Hooli logo' },
  { src: '/logos/logo6.svg', alt: 'Vehement Capital Partners logo' }
];
